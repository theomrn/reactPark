...
import { Save, Shuffle, DoorOpen } from 'lucide-react'
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.toolbox}>
        ...
        <div className={styles.toolboxGroup}>
          <button onClick={handleAutoFill} className={styles.btnAuto}>
            <Shuffle size={15} />
            Remplir auto
          </button>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.panel}>
          ...
          >
            <DoorOpen size={15} style={{ flexShrink: 0 }} />
            Entrée
          </div>
            ...
            >
              {Array.from({ length: rows * cols }, (_, i) => {
                ...
                return (
                  ...
                  >
                    {isEntrance && <DoorOpen size={22} color="#E65100" strokeWidth={2} />}
